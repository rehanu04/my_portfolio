...
const CHIP_BG: Record<string, string> = {
  ...
  ai:       'bg-cyan-500/15 text-cyan-galactic border border-cyan-500/30',
...
function MetricBar({ value, delay }: { value: number; delay: number }) {
  ...
  return (
    <div className="h-1.5 bg-surface-3 rounded-full overflow-hidden">
      <animated.div
        className="h-full rounded-full bg-gradient-to-r from-cyan-galactic via-cyan-dim to-blue-400"
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="glass-deep scanlines border border-t-0 border-cyan-galactic/20 relative overflow-hidden">
            {/* Subtle top line accent */}
            <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-cyan-galactic/50 to-transparent" />
            ...
            <div className="p-6 space-y-6 relative z-10">
                  ...
                  {project.metrics.map((m, i) => (
                    <div key={m.label} className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-mono text-xs text-cyan-galactic text-glow-cyan">
                      ...
                      {typeof m.value === 'number' ? (
                        ...
                        <div className="h-px bg-gradient-to-r from-cyan-galactic/40 to-transparent" />
                      )}
                    </div>
                  ))}
                </div>
              ...
              <div className="p-4 border-l-2 border-cyan-galactic/50 bg-surface-3/40">
                <p className="font-mono text-[10px] text-cyan-galactic tracking-wider mb-2">
