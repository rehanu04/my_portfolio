      ...
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        >
          <p className="font-mono text-xs tracking-[0.32em] text-cyan-galactic uppercase mb-5">
            sys::uplink — SECTION_04
          </p>
          <h2 className="font-display font-bold text-4xl md:text-6xl text-text-primary leading-tight mb-4">
            SECURE
            <br />
            <span className="text-cyan-galactic text-glow-cyan">UPLINK</span>
          </h2>
          <p className="text-text-muted font-display text-lg max-w-md mx-auto leading-relaxed">
            Encrypted professional communications array. Direct channels for high-signal executive outreach.
          </p>
        </motion.div>
          ...
          {LINKS.map((link, idx) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-4">
                {/* Icon box */}
                <div className="w-11 h-11 border border-surface-3 group-hover:border-cyan-galactic flex items-center justify-center text-text-muted group-hover:text-cyan-galactic transition-all duration-300 group-hover:glow-cyan-sm">
                  {link.icon}
                </div>
                ...
                <div>
                  ...
                  <p className="font-mono text-xs text-text-muted mt-0.5">{link.sublabel}</p>
                </div>
        ...
        >
          ...
          <p className="font-mono text-[10px] text-text-muted tracking-wider">
            © 2025 MOHAMMED REHAN — ALL SYSTEMS OPERATIONAL
          </p>
